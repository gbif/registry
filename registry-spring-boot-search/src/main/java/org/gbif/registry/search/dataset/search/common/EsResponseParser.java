...
public class EsResponseParser<T,S, P extends SearchParameter>{
  ...
  public List<S> buildSuggestResponse(org.elasticsearch.action.search.SearchResponse esResponse,
                                           P parameter) {
  ...
  private Optional<List<Facet<P>>> parseFacets(org.elasticsearch.action.search.SearchResponse esResponse, FacetedSearchRequest<P> request) {
