...
public class DoiUpdateListener extends AbstractMessageCallback<ChangeDoiMessage> {
  ...
  public DoiUpdateListener(DoiService doiService, DoiPersistenceService doiMapper) {
   ...
   *
   * @param msg a message from the queue containing main information (DOI, target URL, string XML metadata)
   */
  @Override
  @RabbitListener(queues = RabbitListenerConfiguration.QUEUE_REGISTRY_DOI)
