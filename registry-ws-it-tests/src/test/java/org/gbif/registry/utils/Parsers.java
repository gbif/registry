...
public class Parsers {
  ...
  /**
   * Configure a non validating, namespace aware, SAXParserFactory and return it. </br> Note: this
   * method is copied directly out of the IPT.
   *
   ...
   * The resulting string is concatenating all content and inserts a space at every element or
   * attribute start. </br> Note: this class is copied directly out of the IPT. It also uses a
    ...
    public void endElement(String uri, String localName, String name) throws SAXException {
      if (name.equalsIgnoreCase("key")) {
        key = content.replaceAll("\\s", "");
          ...
          || name.equalsIgnoreCase("organizationKey")) {
  ...
  /**
   * Super simple SAX handler that parses all LegacyDatasetResponse elements expected in an XML
   * Response. The resulting string is concatenating all content and inserts a space at every
   * element or attribute start.
   *
  ...
  public static class LegacyDatasetResponseHandler extends DefaultHandler {
    ...
    public void endElement(String uri, String localName, String name) throws SAXException {
      if (name.equalsIgnoreCase(LegacyResourceConstants.KEY_PARAM)) {
        key = content;
      } else if (name.equalsIgnoreCase(LegacyResourceConstants.ORGANIZATION_KEY_PARAM)
          || name.equalsIgnoreCase("organizationKey")) {
  ...
  /**
   * Super simple SAX handler that parses all LegacyOrganizationResponse elements expected in an XML
   * Response. The resulting string is concatenating all content and inserts a space at every
   * element or attribute start.
   *
  ...
  /**
   * Super simple SAX handler parses all LegacyEndpointResponse elements expected in an XML
   * Response. The resulting string is concatenating all content and inserts a space at every
   * element or attribute start.
   *
