...
public class DigirResource {
  ...
  @BeanPropertySetter(pattern = "response/content/metadata/provider/resource/maxSearchResponseRecords")
  private int maxSearchResponseRecords;
  @BeanPropertySetter(pattern = "response/content/metadata/provider/resource/maxInventoryResponseRecords")
  ...
  public void addRelatedInformation(
    @CallParam(pattern = "response/content/metadata/provider/resource/relatedInformation") URI relatedInformation
  ) {
  ...
  public void addConceptualSchema(
    @CallParam(pattern = "response/content/metadata/provider/resource/conceptualSchema") String namespace,
    @CallParam(pattern = "response/content/metadata/provider/resource/conceptualSchema",
               attributeName = "schemaLocation") URI schemaLocation
  ) {
