 ...
 *
 * Allows either ISO 8601 extended format (e.g. 2016-01-27T13:38:30+01:00)
 * or basic format (e.g. 20160127T133830+0100)
 * plus some degenerate formats observed in use (2016/01/27, a space instead of T, etc).
 */
public class DateTimeConverter implements Converter {
  ...
  private static DateTimeFormatter basicDateOptionalTime() {
    DateTimeFormatter timeOrOffset = new DateTimeFormatterBuilder()
