...
/**
 * This object represents the data received when doing an inventory request using the new functionality as of BioCASe
 * 3.4.
 *
 * @see <a href="http://wiki.bgbm.org/bps/index.php/VersionHistory#Version_3.4_.5B2013-02-20.5D">BioCASe Version
 *      History</a>
 */
