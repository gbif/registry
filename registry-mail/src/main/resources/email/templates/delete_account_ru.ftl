...
<p style="margin: 0 0 20px;padding: 0;line-height: 1.65;">Если вы все же цитируете загрузку GBIF.org, напишите по адресу <a href="mailto:communications@gbif.org" style="color: #509E2F;text-decoration: none;">communications@gbif.org</a>, указав DOI.</p>
</#if>
