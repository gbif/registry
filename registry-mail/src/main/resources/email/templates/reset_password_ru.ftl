...
<p style="margin: 0;padding: 0;line-height: 1.65;margin-bottom: 20px;">Мы получили запрос на сброс пароля вашей учетной записи GBIF. Нажмите на кнопку, чтобы сбросить пароль:</p>
