...
<p style="margin: 0 0 20px;padding: 0;line-height: 1.65;">We received a request to reset the password of your GBIF account. Please click the following button to reset your password:</p>
