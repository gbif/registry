...
<p style="margin: 0 0 20px;padding: 0;line-height: 1.65;">Ми отримали запит на скидання пароля вашого облікового запису GBIF. Будь ласка, натисніть на кнопку нижче, щоб скинути пароль:</p>
