...
<p style="margin: 0 0 20px;padding: 0;line-height: 1.65;">Recebemos uma solicitação para redefinir a senha de sua conta GBIF. Clique no botão abaixo para redefinir sua senha:</p>
