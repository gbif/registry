...
<p style="margin: 0 0 20px;padding: 0;line-height: 1.65;">GBIFアカウントのパスワード変更の依頼を受け付けました。 下のボタンをクリックしてパスワードをリセットしてください。</p>
