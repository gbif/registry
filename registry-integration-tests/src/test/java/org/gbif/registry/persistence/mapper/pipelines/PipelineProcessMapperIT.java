...
public class PipelineProcessMapperIT {
  ...
  @Autowired private PipelineProcessMapper pipelineProcessMapper;
  ...
  public void getPipelineProcessesByDatasetAndAttemptsTest() {
    ...
    List<PipelineProcess> processes =
        pipelineProcessMapper.getPipelineProcessesByDatasetAndAttempts(
            datasetKey, Arrays.asList(1, 2));
