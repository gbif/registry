...
public class NetworkRequestSearchParamsHandlerMethodArgumentResolver
    extends BaseRequestSearchParamsHandlerMethodArgumentResolver
    implements HandlerMethodArgumentResolver {

  @Override
  public boolean supportsParameter(MethodParameter parameter) {
    return NetworkRequestSearchParams.class.equals(parameter.getParameterType());
  }
  ...
  public Object resolveArgument(
    ...
    NetworkRequestSearchParams params = new NetworkRequestSearchParams();
