...
public class DatasetResource extends BaseNetworkEntityResource<Dataset>
  ...
  @Operation(operationId = "getNetworks", summary = "List the networks the dataset belongs to")
  @Docs.DefaultEntityKeyParameter
  ...
  @Operation(operationId = "getAllMetadata", summary = "Retrieve all dataset source metadata")
  @Docs.DefaultEntityKeyParameter
  ...
  @Operation(operationId = "getDeletedDatasets", summary = "List all deleted datasets")
  @Docs.DefaultOffsetLimitParameters
  ...
  @Operation(operationId = "getDuplicateDatasets", summary = "List all duplicate datasets")
  @Docs.DefaultOffsetLimitParameters
  ...
  @Operation(operationId = "getNoEndpointDatasets", summary = "List all datasets with no endpoint")
  @Docs.DefaultOffsetLimitParameters
   ...
   * crawl, and applies necessary security.
   */
  @Operation(operationId = "crawlDataset", summary = "Schedule a new ingestion of the dataset")
  @Docs.DefaultEntityKeyParameter
