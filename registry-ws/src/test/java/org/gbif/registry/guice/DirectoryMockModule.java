...
public class DirectoryMockModule extends AbstractModule {
  ...
  private static class NodeServiceMock implements NodeService {
    ...
    @Override
    public org.gbif.api.model.directory.Node create(@NotNull org.gbif.api.model.directory.Node node) {
      return null;
    }
    ...
    @Override
    public PagingResponse<org.gbif.api.model.directory.Node> list(@Nullable String s, @Nullable Pageable pageable) {
      return null;
    }
  }
