...
public class MockDatasetMapper implements DatasetMapper {
   ...
   * Warning: this method will add the country as a distinct country and increment the dataset counts for that country
   * @param country
   */
  ...
  /**
   * Mock specific method
   * Warning: this method sets datasetsByInstallation to 1 for the specified country
   * @param installation
   */
  ...
  @Override
  public List<Dataset> listConstituents(@Param("parentKey") UUID parentKey, @Nullable @Param("page") Pageable page) {
    return null;
  }

  @Override
  public List<Dataset> listDatasetsInNetwork(@Param("networkKey") UUID networkKey, @Nullable @Param("page") Pageable page) {
    return null;
  }

  @Override
  public List<Dataset> listDatasetsPublishedBy(@Param("organizationKey") UUID organizationKey, @Nullable @Param("page") Pageable page) {
    return null;
  }

  @Override
  public List<Dataset> listDatasetsHostedBy(@Param("organizationKey") UUID organizationKey, @Nullable @Param("page") Pageable page) {
    return null;
  }

  @Override
  public List<Dataset> listDatasetsEndorsedBy(@Param("nodeKey") UUID nodeKey, @Nullable @Param("page") Pageable page) {
    return null;
  }

  @Override
  public List<Dataset> listWithFilter(@Nullable @Param("country") Country country, @Nullable @Param("type") DatasetType type, @Nullable @Param("page") Pageable page) {
    return null;
  }

  @Override
  public List<Dataset> listWithFilter(@Nullable @Param("country") Country country, @Nullable @Param("type") DatasetType type, @Nullable @Param("installation_key") UUID installationKey, @Nullable @Param("date_from") Date from, @Nullable @Param("date_to") Date to, @Nullable @Param("page") Pageable page) {
    return null;
  }
  ...
  @Override
  public List<Dataset> listDatasetsByInstallation(@Param("installationKey") UUID installationKey, @Nullable @Param("page") Pageable page) {
    return null;
  }
  ...
  @Override
  public int addContact(@Param("targetEntityKey") UUID entityKey, @Param("contactKey") int contactKey, @Param("type") ContactType contactType, @Param("isPrimary") boolean isPrimary) {
    return 0;
  }

  @Override
  public void updatePrimaryContacts(@Param("targetEntityKey") UUID entityKey, @Param("type") ContactType contactType) {
  ...
  @Override
  public int deleteContact(@Param("targetEntityKey") UUID entityKey, @Param("contactKey") int contactKey) {
    return 0;
  }
  ...
  @Override
  public List<Dataset> search(@Nullable @Param("query") String query, @Nullable @Param("page") Pageable page) {
    return null;
  }
  ...
  @Override
  public List<Dataset> listByIdentifier(@Nullable @Param("type") IdentifierType type, @Param("identifier") String identifier, @Param("page") Pageable page) {
    return null;
  }
