...
VALUES('0a16da09-7719-40de-8d4f-56a15ed52fb6'::uuid,'02c40d2a-1cba-4633-90b7-e36e5e97aba8'::uuid,true::boolean,'password','Test Organisation #1','Test Organisation for IPT','EN','{helpdesk@gbif.org}','{+45 35 32 14 70}','{https://www.gbif.org/}','https://rs.gbif.org/style/logo.svg','{Universitetsparken 15}','Copenhagen','DK','2100','55.6761','55.6761',now(),now(),'Script', 'Script');
...
INSERT INTO organization(key,endorsing_node_key,endorsement_approved,password,title,description,language,email,phone,homepage,logo_url,address,city,country,postal_code,latitude,longitude,created,modified,created_by,modified_by)
VALUES('62922b92-69d1-4c4b-831c-b23d5412a124'::uuid,'02c40d2a-1cba-4633-90b7-e36e5e97aba8'::uuid,true::boolean,'password','Test Organisation Jenkins','Test Organisation for IPT built by Jenkins','EN','{helpdesk@gbif.org}','{+45 35 32 14 70}','{https://builds.gbif.org/}','https://rs.gbif.org/style/logo.svg','{Universitetsparken 15}','Copenhagen','DK','2100','55.6761','55.6761',now(),now(),'Script', 'Script');
