...
public interface ParticipantClient extends ParticipantService {
  ...
  @Override
  default PagingResponse<Participant> list(String query, Pageable pageable) {
    throw new WebApplicationException(
        "Participant list by client is not supported", HttpStatus.BAD_REQUEST);
  }
