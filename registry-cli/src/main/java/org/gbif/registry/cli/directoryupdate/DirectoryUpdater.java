...
public class DirectoryUpdater {
  ...
  @Inject
  public DirectoryUpdater(ParticipantService directoryParticipantService, org.gbif.api.service.directory.NodeService directoryNodeService,
                          NodeMapper nodeMapper, IdentifierMapper identifierMapper){
