...
public class UserManagementIT {
  ...
  // TODO: 2019-08-15 sign requests by GbifAuthService instead of using hardcoded signatures
  // TODO: 2019-08-16 change gbif.registry-ws-client-it to gbif.app.it and introduce a constant
    ...
    mvc
        .perform(
            get("/admin/user/find")
                ...
                .header(SecurityConstants.HEADER_GBIF_USER, "gbif.registry-ws-client-it")
                // sign can be generated by GbifAuthService#signRequest
                .header(HttpHeaders.AUTHORIZATION, "GBIF gbif.registry-ws-client-it:9mTFPdcwRKpM9vuqao4cbA9hg5w="))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.user.userName").value("justadmin"))
        .andExpect(jsonPath("$.error").doesNotExist());
    ...
    mvc
        .perform(
            post("/admin/user/resetPassword")
                ...
                // sign can be generated by GbifAuthService#signRequest
                .header(HttpHeaders.AUTHORIZATION, "GBIF gbif.registry-ws-client-it:ThBC9tA7P/cZ6thcSpdTCo14y30="))
        .andDo(print())
    ...
    mvc
        .perform(
            post("/admin/user/updatePassword")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"password\":\"newpass\",\"challengeCode\":\"" + UUID.randomUUID() + "\"}")
                .header(SecurityConstants.HEADER_GBIF_USER, "user_update_password")
                // sign can be generated by GbifAuthService#signRequest
                .header(HttpHeaders.AUTHORIZATION, "GBIF gbif.registry-ws-client-it:1PDFNjdtvux5xb5n4CBEinofB78="))
        .andDo(print())
        .andExpect(status().isUnauthorized());
    ...
    mvc
        .perform(
            post("/admin/user/resetPassword")
                .header(SecurityConstants.HEADER_GBIF_USER, "user_update_password")
                // sign can be generated by GbifAuthService#signRequest
                .header(HttpHeaders.AUTHORIZATION, "GBIF gbif.registry-ws-client-it:1qWh7bNP+FAkbdilPxwXYDtGmkk="))
        .andDo(print())
        .andExpect(status().isNoContent());
    ...
    mvc
        .perform(
            get("/admin/user/confirmationKeyValid")
                ...
                .header(SecurityConstants.HEADER_GBIF_USER, "user_update_password")
                // sign can be generated by GbifAuthService#signRequest
                .header(HttpHeaders.AUTHORIZATION, "GBIF gbif.registry-ws-client-it:+zrgwIn10CE7jklgf0hUVz/y794="))
        .andDo(print())
        .andExpect(status().isNoContent());
