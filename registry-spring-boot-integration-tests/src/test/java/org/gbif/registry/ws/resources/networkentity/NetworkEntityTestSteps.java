...
public class NetworkEntityTestSteps {
  ...
  public void setUp() throws Exception {
    ...
    ScriptUtils.executeSqlScript(connection,
      new ClassPathResource("/scripts/networkentity/network_entity_prepare.sql"));
  ...
  public void createEntity(String entityType, String userType, String username, String password) throws Exception {
    NetworkEntity entity = NetworkEntityProvider.prepare(entityType, NODE_KEY, ORGANIZATION_KEY, INSTALLATION_KEY);
  ...
  public void updateEntity(String entityType, String userType, String username, String password,
                           Map<String, String> fieldsToUpdate) throws Exception {
  ...
  public void listEntityContacts(String entityType) throws Exception {
    result = mvc
      .perform(
        get("/" + entityType + "/{key}/contact", entityKey));
  }
  ...
  public void deleteContact(String entityType) throws Exception {
    result = mvc
      .perform(
        delete("/" + entityType + "/{key}/contact/{contactKey}", entityKey, contacts.get(0).getKey())
          .with(httpBasic(TEST_ADMIN, TEST_PASSWORD)));
  }
  ...
  public void listEntityEndpoints(String entityType) throws Exception {
    result = mvc
      .perform(
        get("/" + entityType + "/{key}/endpoint", entityKey));
  }
  ...
  public void listEntityComments(String entityType) throws Exception {
    result = mvc
      .perform(
        get("/" + entityType + "/{key}/comment", entityKey));
  }
  ...
  public void listEntityMachineTags(String entityType) throws Exception {
    result = mvc
      .perform(
        get("/" + entityType + "/{key}/machineTag", entityKey));
  }
  ...
  public void listEntityTags(String entityType) throws Exception {
    result = mvc
      .perform(
        get("/" + entityType + "/{key}/tag", entityKey));
  }
