...
Feature: IPT related functionality
  ...
  Scenario: Register IPT installation
    ...
    When register new installation for organization "Org" using organization key and password "welcome"
  ...
  Scenario: Update IPT installation
    ...
    When update installation "Test IPT Registry2" using installation key and password "welcome"
