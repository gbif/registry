...
Feature: LegacyOrganizationResource functionality
  ...
  Scenario: request Organization (GET) with no parameters and .json, signifying that the response must be JSON
    ...
    When get organization "0af41159-061f-4693-b2e5-d3d062a8285d" with no credentials
    Then response status should be 200
    And JSON is expected
